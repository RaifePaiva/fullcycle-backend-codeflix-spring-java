...
class UpdateCategoryUseCaseTest extends UseCaseTest {
    ...
    void givenAInvalidName_whenCallsUpdateCategory_thenShouldReturnDomainException(){
        ...
        final String exceptedName = null;
        final var expectedDescription = "A Categoria mais assistida";
        final var expectedIsActive = true;
        ...
        final var aCommand = UpdateCategoryCommand.with(
                expectedId.getValue(), exceptedName, expectedDescription, expectedIsActive);
    ...
    @Test
    void givenAInactivateCommand_whenCallsUpdateCategory_shouldReturnInactiveCategoryId(){
        final var aCategory = Category.newCategory("Film", null, true);

        final String exceptedName = "Filmes";
        final var expectedDescription = "A Categoria mais assistida";
        ...
        Mockito.verify(categoryGateway, times(1)).update(argThat(
                aUpdatedCategory ->
                        Objects.equals(exceptedName, aUpdatedCategory.getName())
                                && Objects.equals(expectedDescription, aUpdatedCategory.getDescription())
                                && Objects.equals(expectedIsActive, aUpdatedCategory.isActive())
                                && Objects.equals(expectedId, aUpdatedCategory.getId())
                                && Objects.equals(aCategory.getCreatedAt(), aUpdatedCategory.getCreatedAt())
